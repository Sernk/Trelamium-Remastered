...
{
    public class AquaticScourgeProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Aquatic Beam");
        ...
        {
            //target.AddBuff(mod.BuffType("SirensLament"), 300, true);
        }
        public override void AI()
        {
            ...
            if (Projectile.alpha > 0)
            {
                ...
                while ((float)num103 < num102)
                {
                    ...
                    int num104 = Dust.NewDust(Projectile.Center, 0, 0, 172, 0f, 0f, 0, default(Color), 1f);
                    Main.dust[num104].scale = 1f;
