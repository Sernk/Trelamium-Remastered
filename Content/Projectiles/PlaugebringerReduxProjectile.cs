...
{
    public class PlaugebringerReduxProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Plaugebringer Redux");
        ...
        public override void SetDefaults()
        {
            ...
            ProjectileID.Sets.YoyosLifeTimeMultiplier[Projectile.type] = 15.25f;
