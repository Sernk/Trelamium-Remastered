...
{
    public class SaguaroProjectile : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            ProjectileID.Sets.YoyosLifeTimeMultiplier[Projectile.type] = 8.75f;
            ProjectileID.Sets.YoyosMaximumRange[Projectile.type] = 205f;
            ProjectileID.Sets.YoyosTopSpeed[Projectile.type] = 8.95f;
