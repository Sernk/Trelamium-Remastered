...
{
    public class AquafinityProjectile : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            ProjectileID.Sets.YoyosLifeTimeMultiplier[Projectile.type] = 10.75f;
        ...
        public override void PostAI()
        {
            ...
            {
                Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, 172);
                dust.noGravity = true;
                dust.scale = 1.25f;
            }
        }
