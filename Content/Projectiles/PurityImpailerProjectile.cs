...
{
    public class PurityImpailerProjectile : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                Dust dust = Dust.NewDustDirect(usePos, Projectile.width, Projectile.height, 44);
        ...
        public override void AI()
        {
            ...
            if (!isStickingToTarget)
            {
                ...
                {
                    Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.height, Projectile.width, 44,
