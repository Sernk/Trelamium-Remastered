...
{
    public class ReaperScytheProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Wanning Reaper Scythe");
        }
        ...
        {
            target.AddBuff(ModContent.BuffType<Moonburn>(), 300, true);
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                for (int num253 = 0; num253 < num252; num253 = num3 + 1)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.oldPosition.X + (float)(Projectile.width / 2), Projectile.oldPosition.Y + (float)(Projectile.height / 2), vector12.X, vector12.Y, ModContent.ProjectileType<ReaperScytheHealProjectile>(), Projectile.damage / 2, Projectile.knockBack * 0.8f, Projectile.owner, 0f, 0f);
                    num3 = num253;
                }
            }
