...
{
    public class PrevalenceArrowProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Prevalence Arrow");
