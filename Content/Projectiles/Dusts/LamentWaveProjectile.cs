...
{
    public class LamentWaveProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Lament Wave");
        ...
        {
            target.AddBuff(ModContent.BuffType<SirensLament>(), 300, true);
        }
        ...
        public override void AI()
        {
            ...
            for (int num452 = 0; num452 < 4; num452 = num3 + 1)
            {
                ...
                int num453 = Dust.NewDust(vector36, 1, 1, 172, 0f, 0f, 0, default(Color), 1f);
