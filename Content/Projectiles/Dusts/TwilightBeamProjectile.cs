...
{
    public class TwilightBeamProjectile : ModProjectile
    {
        ...
        {
            //target.AddBuff(mod.BuffType("Twilight"), 240, true);
        }
        ...
        public override void AI()
        {
            ...
            for (int num452 = 0; num452 < 4; num452 = num3 + 1)
            {
                ...
                int num453 = Dust.NewDust(vector36, 1, 1, 21, 0f, 0f, 0, default(Color), 1f);
