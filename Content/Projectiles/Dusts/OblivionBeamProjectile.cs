...
{
    public class OblivionBeamProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Oblivion Rift");
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int num237 = 0; num237 < num229; num237 = num3 + 1)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vector11.X, vector11.Y, ModContent.ProjectileType<OblivionBoltProjectile>(), (int)((double)Projectile.damage * 0.7), Projectile.knockBack * 0.7f, Projectile.owner, 0f, 0f);
                num3 = num237;
            }
        }
