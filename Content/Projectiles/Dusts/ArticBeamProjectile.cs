...
{
    public class ArticBeamProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Artic Beam");
        }
        ...
        {
            //target.AddBuff(mod.BuffType("EuphoranFreeze"), 300, true);
        }
        ...
        public override void AI()
        {
            ...
            for (int num452 = 0; num452 < 4; num452 = num3 + 1)
            {
                ...
                Main.dust[num453].scale = (float)Main.rand.Next(60, 61) * 0.014f;
