...
{
    public class VoidBeamProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Necroplasmic Voidbeam");
        }
        ...
        {
            target.AddBuff(ModContent.BuffType<Necroplasm>(), 300, true);
        }
        ...
        public override void AI()
        {
            ...
            for (int num452 = 0; num452 < 4; num452 = num3 + 1)
            {
                ...
                Main.dust[num453].scale = (float)Main.rand.Next(80, 81) * 0.018f;
