...
{
    public class AspireHealProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Cadence Heal");
        }
        ...
        public override void AI()
        {
            ...
            for (int num498 = 0; num498 < 3; num498 = num3 + 1)
            {
                ...
                int num501 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 71, 0f, 0f, 100, default(Color), 1.1f);
    ...
    /*										for (int num502 = 0; num502 < 5; num502 = num3 + 1)
                                            {
                                                ...
                                                int num505 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 175, 0f, 0f, 100, default(Color), 1.3f);
