...
{
    public class DispairBeamProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Despair Beam");
        }
        ...
        {
            //target.AddBuff(mod.BuffType("Dispair"), 300, true);
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<DispairHealProjectile>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
        }
