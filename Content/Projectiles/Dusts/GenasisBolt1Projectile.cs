...
{
    public class GenasisBolt1Projectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num340 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 173, Projectile.velocity.X, Projectile.velocity.Y, 50, default(Color), 1.1f);
            ...
            {
                int num342 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 173, Projectile.velocity.X, Projectile.velocity.Y, 50, default(Color), 0.6f);
