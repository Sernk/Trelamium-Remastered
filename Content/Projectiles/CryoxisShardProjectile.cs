...
{
    public class CryoxisShardProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num335 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 113, Projectile.velocity.X, Projectile.velocity.Y, 50, default(Color), 1.2f);
            ...
            {
                int num337 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 67, Projectile.velocity.X, Projectile.velocity.Y, 50, default(Color), 0.4f);
                if (num336 == 0)
                {
