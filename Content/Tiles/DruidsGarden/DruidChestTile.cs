...
{
    public class DruidChestTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            DustType = 74;
            AddMapEntry(new Color(0, 120, 0), this.GetLocalization("MapEntry0"), MapChestName);
            AddMapEntry(new Color(0, 120, 0), this.GetLocalization("MapEntry1"), MapChestName);
